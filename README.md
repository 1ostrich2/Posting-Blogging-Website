...
⚠️ Notes <br />
- This is a prototype and focuses more on functionality than design. The user interface is basic, but the core features are implemented and are working. <br />
<br />
...
git clone https://github.com/1ostrich2/Flask-Social-Media-App.git <br />
cd Flask-Social-Media-App/"My Blog Page" <br />
